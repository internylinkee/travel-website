...
class FormPostReviews extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      image: {
  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      ...
      return this.props.onSubmit({ ...values, type: variables.TYPE_POST.REVIEWS }, this.props.form);
    });
  };
...
export default Form.create({ name: 'FormPostReviews' })(FormPostReviews);
